...
With firmware [FP3.6.A.040.2] on the Fairphone 3, with firmware [FP4.QREL.15.17.2] on the Fairphone 4, with firmware [FP5.VT2X.C.107] on the Fairphone 5 and with firmware [FP6.QREL.16.69.0] on the Fairphone (Gen. 6/Gen. 6+), Fairphone switched to the [standard unlock procedure](../../misc/generic-unlock.md). The OEM unlock option still requires an internet connection to verify the request.
